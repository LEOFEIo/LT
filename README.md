...
一套可直接上传 GitHub、部署到 Vercel 的全栈 AI 人才招聘网站。V7 使用 Linear-inspired 深色产品系统和 DINQ 式人才智能工作流；所有品牌、图标、文案和演示数据均为原创，与 Linear 无官方关联。

## 这个版本包含

- Linear-inspired 近黑画布、四级表面、单一薰衣草交互色与紧凑工作台布局
